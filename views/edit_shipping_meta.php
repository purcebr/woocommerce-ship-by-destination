<table class="ship_zones_country ship_zones_edit form-table">
	...
	<tr class="form-field">     
		<th scope="row" class="titledesc"><label for="use_custom_notice"><?php _e('Use Custom Notice','woocommerce_ship_by_destination'); ?></label></th>
		<td class="forminp">
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e('Customize Notice Message?','woocommerce_ship_by_destination'); ?></span></legend>
				<select  id="has_custom_notice" name="term_meta[use_custom_notice]" id="use_custom_notice" style="" class="select use_custom_notice"><option value="default" <?php echo (!$has_custom_notice) ? " selected='selected' " : ''; ?> ><?php _e('Default Notice','woocommerce_ship_by_destination'); ?></option><option value="custom" <?php echo ($has_custom_notice) ? " selected='selected' " : ''; ?> ><?php _e('Add Custom Notice','woocommerce_ship_by_destination'); ?></option></select><br />
	...
	<tr id="custom_shipping_notice" class="form-field">
		<th scope="row" class="titledesc"><label for="woocommerce_free_shipping_countries"><?php _e('Custom Notice Message','woocommerce_ship_by_destination'); ?></label></th>
		<td class="forminp">
			<fieldset><legend class="screen-reader-text"><span><?php _e('Custom Notice Message','woocommerce_ship_by_destination'); ?></span></legend>
				<textarea name="term_meta[custom_notice]" class="custom_error"><?php echo $term_data['custom_notice'];?></textarea><br />
	...
	<tr class="form-field">     
		...
		<td class="forminp">
			<fieldset>
				<legend class="screen-reader-text"><span><?php _e('Customize Error Message','woocommerce_ship_by_destination'); ?></span></legend>
	...
	<tr id="custom_shipping_error" class="form-field">
		<th scope="row" class="titledesc"><label for="woocommerce_free_shipping_countries"><?php _e('Custom Error Message','woocommerce_ship_by_destination'); ?></label></th>
		<td class="forminp">

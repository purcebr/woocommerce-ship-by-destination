...
<div id="use_custom_shipping_notice" class="form-field custom_notice_box">
	<div class="boxes_toggle">
...
<div id="custom_shipping_notice" class="form-field custom_notice_box">
	<div class="boxes_toggle">
		...
		<p><?php _e('A custom notice on the cart page (and checkout page, for virtual products) indicating that the product might not be available for purchase in the selected country.','woocommerce_ship_by_destination'); ?></p>
	</div>
</div>
